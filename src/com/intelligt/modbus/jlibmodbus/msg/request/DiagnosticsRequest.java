 ...
 * The function uses a two–byte sub-function code field in the query to define the type of com.intelligt.modbus.jlibmodbus.test to
...
public class DiagnosticsRequest extends ModbusRequest {
    /**
     * Diagnostic uses a two–byte sub-function code field in the query to define the type of com.intelligt.modbus.jlibmodbus.test to
     * be performed.
     */
